\documentclass[a4paper,3p,twoside]{report}
\usepackage{type1cm}
...
% bibname rename không dùng được với biblatex — đã xóa, dùng title= trong \printbibliography thay thế
...
\IfFileExists{lstlisting.tex}{\input{lstlisting}}{}
% Tu_viet_tat.tex is included in the document body below.
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
% Chương hướng dẫn template đã bỏ
% \chapter*{MỘT SỐ LƯƠ Ý VỀ TÀI LIỆU THAM KHẢO}
% \label{chapter:reference}
% \subfile{Chuong/7_Luu_y_tai_lieu_tham_khao_clean}

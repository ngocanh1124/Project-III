...
{\textbf{\Large{Nghiên cứu giải pháp quản lý ra vào từ xa tích hợp căn cước công dân}}\\[1cm]

{\textbf{\large{NGUYỄN THỊ NGỌC ANH}}}\\
{\large{anh.ntn225252@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. Nguyễn Đình Thuận \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]

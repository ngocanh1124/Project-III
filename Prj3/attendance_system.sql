...
CREATE TABLE IF NOT EXISTS devices (
    ...
    direction ENUM('IN', 'OUT') DEFAULT 'IN' COMMENT 'IN=Chiều vào, OUT=Chiều ra',
...
CREATE TABLE IF NOT EXISTS attendance_logs (
    ...
    direction ENUM('IN', 'OUT') COMMENT 'IN=Vào, OUT=Ra (tự động từ device_code)',
...
INSERT INTO roles (role_name) VALUES ('SUPER_ADMIN'), ('ADMIN'), ('HR_MANAGER'), ('OPERATOR'), ('VIEWER');
...
INSERT INTO devices (device_code, location_name, direction) VALUES 
('GATE_01_IN', 'Cổng Chính - Chiều Vào', 'IN'),
('GATE_01_OUT', 'Cổng Chính - Chiều Ra', 'OUT');